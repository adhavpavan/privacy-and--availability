...
chaincodeInvoke() {
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_ORG1_CA \
        --peerAddresses localhost:9051 --tlsRootCertFiles $PEER0_ORG2_CA   \
        -c '{"function": "CreateContract","Args":["{\"contract\":\"Laptop Contract\",\"createAt\":\"2022-09-10T11:15:06.254Z\",\"createBy\":\"user42@gmail.com\",\"id\":\"legal\",\"docType\":\"Patient\",\"dob\":\"2022-09-10\",\"gender\":\"male\"}"]}'
